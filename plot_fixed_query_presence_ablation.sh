#!/bin/bash
#SBATCH --job-name=doob_presence_plot
...
"${RELgDIFF_PYTHON}" -u plot_fixed_query_checkpoint_histograms.py \
    --series "active_flags=${ABLATION_SAMPLE_ROOT}/active_flags" \
    --series "implicit_domain=${ABLATION_SAMPLE_ROOT}/implicit_domain" \
